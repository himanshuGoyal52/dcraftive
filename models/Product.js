...
const productSchema = new mongoose.Schema(
    {
        ...
        faq : {type : Array , default : [{ ques : 'What is the estimated time for a delivery?' , ans : "Once we receive the order confirmation, products are typically manufactured and dispatched within 4 - 6 weeks. We will notify you once the product has been dispatched for delivery. All the products that can be dispatched immediately are highlighted with Fast Shipping on the website. Every product is transported and delivered through our shipping partner's delivery network or our trusted third-party logistics. Although we try to make sure that the Product reaches you within the specified time of delivery, circumstances, such as transport strikes, heavy rains, floods, natural calamities, border clearance, etc., might arise which may result in a delay. In such a case, we request you to not worry. Get in touch with our Email Support Team at support@dcraftive.com for the latest updates and information regarding your shipment, if we already haven’t been in touch with you for the same. For a fully customised product, which is being made from scratch, prototyping can result in the delivery taking more time than the standard delivery time."}]},
